  ...
  return (
    <ContainerCentralizado>
      ...
      <View style={styles.loginArea}>
        ...
        <TextInput style={styles.loginInput} secureTextEntry placeholder={'Senha'} value={senha} onChangeText={(e)=>{setSenha(e)}}/>
        <TextInput style={styles.loginInput} secureTextEntry placeholder={'Confirmar Senha'} value={confirmarSenha} onChangeText={(e)=>{setConfirmarSenha(e)}}/>
      </View>
